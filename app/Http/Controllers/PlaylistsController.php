...
class PlaylistsController extends Controller
{
    ...
    public function addPlaylist(Request $request) {
        ...
        return redirect('/playlist')->with('message', 'Playlist created');
    }
    ...
    public function storeEditPlaylist(Request $request, Playlist $playlist) {
        ...
        return redirect("/playlist/$playlist->id")->with('message', 'playlist updated');
    }

    public function deletePlaylist(Playlist $playlist) {
        $playlist->delete();
        return redirect('/playlist')->with('message', 'Playlist removed');
    }
}
