...
<x-dash-layout>
    ...
    @if (count($bands) > 0)
        ...
        <div class="flex justify-end mr-4">
            <a href="/admin/createBandForm" class="text-black text-end fixed p-2 w-12 aspect-square bg-blue-400 rounded-full cursor-pointer flex items-center justify-center">
                        ...
                        <div class="relative">
                            ...
                            <div id="userDropdown" class="bg-gray-800 hidden absolute top-6 z-10 w-44 text-white rounded border border-gray-700 divide-y divide-gray-100 shadow">
                                <ul class="py-1 text-sm " aria-labelledby="avatarButton">   
                                    <li>
                                        <a href="/admin/editBandForm/{{$band->id}}" class="block py-2 px-4 text-center text-green-400 hover:bg-blue-400 hover:text-black"><i class="fa-solid fa-pen mr-2"></i>Edit Band {{$band->id}}</a>
                                    </li>
                                    <li class="">
                                        <button data-modal-toggle="deleteModal" value="{{$band->id}}" class="deleteBtn text-red-500 text-center block py-2 px-4 hover:bg-blue-400 hover:text-black w-full">
