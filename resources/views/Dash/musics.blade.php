<x-dash-layout>
    ...
    <div class="flex justify-end mr-4">
        <a href="/admin/createMusic" class="text-black text-end fixed p-2 w-12 aspect-square bg-blue-400 rounded-full cursor-pointer flex items-center justify-center">
