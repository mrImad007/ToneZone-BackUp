...
<x-dash-layout>
    ...
    <div class="mt-12 h-full grid grid-cols-1 sm:grid-cols-3 gap-8 ">
        <div class="w-5/6 mx-auto flex flex-col justify-around items-center h-32 bg-white text-black rounded-lg p-2">
            <div>
                <span class="text-md font-semibold">Musics </span><i class="fa-solid fa-hands-holding-child text-2xl text-yellow-400"></i>
            </div>
            <div class="font-semibold text-md">{{$musics}}</div>
        </div>
        <div class="w-5/6 mx-auto flex flex-col justify-around items-center h-32 bg-white text-black rounded-lg p-2">
            <div>
