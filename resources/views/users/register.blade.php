            ...
            <form method="POST" action="/store" class="bg-black text-white w-full flex justify-center items-center p-4 rounded-xl">
                ...
                <div class="w-5/6 grid gap-4">
                    <div class="flex flex-col items-center mb-2">
                        <input type="text" name="name" value="{{old('name')}}" id="fname" placeholder="fullname" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                    ...
                    <div class="flex flex-col items-center mb-2">
                        ...
                        <input type="email" name="email" value="{{old('email')}}" id="email" placeholder="email" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                    ...
                    <div class="flex flex-col items-center mb-2">
                        {{-- old is a helper that save data on the value when submiting --}}
                        <input type="password" name="password" id="pwd" placeholder="password" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                    ...
                    <div class="flex flex-col items-center mb-2">
                        <input type="date" name="age" value="{{old('age')}}" id="date" class="text-gray-400 w-4/6 rounded-full py-1 px-3 shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
