    ...
    <section class="px-6 py-4 h-full bg-[#121212] overflow-y-scroll scrollbar-hide">
        ...
        <div class="grid grid-cols-4 gap-4 ml-2 ">
            ...
            @foreach ($artists as $artist)
                <div id="music" class="allMusics cursor-pointer bg-gray-900 flex flex-col gap-3 rounded-sm hover:bg-blue-100 transition-all duration-500 group shadow-[0px_0px_5px] shadow-blue-400">
