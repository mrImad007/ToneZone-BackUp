    ...
    <div class="w-full bg-gradient-to-b from-[#fc4889] via-[#fd5274] to-[#fd7865]">
        ...
        <div class="w-5/6 mx-auto flex gap-8 p-8 relative ">
            ...
            <div class="flex flex-col justify-around text-white">
                <h3 class="font-bold text-7xl">Liked Songs</h3>
                <div class="flex gap-2 items-center">
                    <p> {{auth()->user()->name}} You like {{count($likedMusic)}} Songs</p>
                </div>
            </div>
        </div>
                ...
                <div class="flex justify-center mt-6">
                    <div class="text-white flex items-center gap-8">
                        ...
                        <div class="flex flex-col gap-4 items-center">
                            <h3 class="text-2xl font-bold">Find songs to like</h3>
                            <a href="/"><button class="text-black bg-purple-400 font-semibold hover:scale-110 rounded-full text-sm px-5 py-3 mr-2 mb-2 ">Library</button></a>
                        </div>
                    </div>
                </div>
