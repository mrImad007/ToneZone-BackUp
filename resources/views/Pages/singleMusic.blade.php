...
<x-layout :playlists="$playlists">
    ...
    {{-- load index with message after loggin blue --}}
    <x-flash-message />
    ...
    <div class="bg-gradient-to-b from-[#1f1f1f] to-[#171717] h-full">
        ...
        <div class="w-5/6 mx-auto p-8 flex items-center gap-8">
            ...
            @if ($like)
                <a href="/unlikeMusic/{{$music->id}}/{{auth()->id()}}" title="Edit playlist"><i class="fa-solid fa-heart text-blue-400 text-4xl hover:text-blue-700 cursor-pointer"></i></a>
            @else
                <a href="/likeMusic/{{$music->id}}/{{auth()->id()}}" title="Edit playlist"><i class="fa-regular fa-heart text-blue-400 text-4xl hover:text-blue-700 cursor-pointer"></i></a>
            @endif
            <div class="" id="playMusic">
                <i id="playBtn" class="fa-solid fa-play text-blue-400 text-4xl hover:text-blue-700 cursor-pointer"></i>
                <i id="pauseBtn" class="fa-solid fa-pause text-blue-400 text-4xl hover:text-blue-700 cursor-pointer"></i>
                <audio id="singleMusicSrc" src="{{$music->music_audio}}" controls hidden></audio>
            </div>
            <i id="commentBtn" class="fa-solid fa-comment text-blue-400 text-4xl hover:text-blue-700 cursor-pointer"></i>
        </div>
        ...
        <section class=" w-5/6 mx-auto" id="commentForm">
            <div class="mx-auto px-4">
                ...
                <form class="mb-6" action="/comment/{{$music->id}}" method="POST">
                    ...
                    <button type="submit"
                        class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-black font-semibold bg-blue-400 rounded-lg focus:ring-4">
                        Post comment
                    </button>
                </form>
            </div>
