                ...
                <div class="flex justify-center mt-6">
                    <div class="text-white flex items-center gap-8">
                        ...
                        <div class="flex flex-col gap-4 items-center">
                            <h3 class="text-2xl font-bold">Start building your playlist</h3>
                            <a href="/"><button class="text-black bg-blue-400 font-semibold hover:scale-110 rounded-full text-sm px-5 py-3 mr-2 mb-2 ">Add a Songs</button></a>
                        </div>
                    </div>
                </div>
