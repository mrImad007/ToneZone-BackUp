<footer id="footer" class="hidden bg-blue-400 col-span-6 p-4 grid grid-cols-3 place-items-center gap-6 fixed z-10 w-full bottom-0">
    <audio controls id="footerMusic" preload="metadata" src="" hidden></audio>
    <div class="flex items-center">
        <div class="overflow-hidden rounded-xl mr-4">
            <img id="footerImg" class="h-14 w-14 flex-shrink-0" src="{{asset('images/avatar.jpeg')}}" alt="" />
        </div>
        <div class="mr-4">
