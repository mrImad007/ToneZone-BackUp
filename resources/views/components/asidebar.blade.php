    ...
    <div class="col-span-1 bg-black row-span-3 pt-4 h-full fixed">
        <div class="px-6 mb-2">
            <a href="/" class="w-full flex justify-around items-center gap-4">
                <img src="{{asset('images/logo1.jpeg')}}" alt="" class="w-10">
                <h1 class="font-bold text-blue-500 text-xl hidden md:block">ToneZone</h1>
            </a>
        </div>
        <div class="px-2 mb-4 mt-6">
            <ul class="text-gray-400">
                <a href="/">
                    <li class=" flex font-semibold items-center px-4 py-2 rounded text-md hover:text-blue-400">
        ...
        <div>
            ...
            <div class="mb-3">
                <div class="px-6 py-2 flex items-center text-sm text-gray-400 hover:text-blue-400 group">
                    <a href="/createPlaylist" class="flex items-center">
                        <i class="fa-solid fa-plus p-1 mr-2 bg-gray-400 text-black group-hover:bg-blue-400"></i>
                        <span class="hidden md:block" title="Create Playlist">Create Playlist</span>
                    </a>
                </div>
                <div class="px-6 py-2 flex items-center text-sm text-gray-400 hover:text-blue-400">
