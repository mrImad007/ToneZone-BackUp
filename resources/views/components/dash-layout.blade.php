...
<head>
    ...
    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="{{asset('images/logo1.jpeg')}}"/>
    {{-- scrip of alpinjs for flash message --}}
    <script src="//unpkg.com/alpinejs" defer></script>
    <title>ToneZone</title>
    <style>
        .scrollbar-hide {
        ...
        <div class="fixed w-full max-sm:h-12 flex items-center justify-between text-white z-20">
            <div class="px-6 mb-2">
                <a href="/">
                    <div class="w-full flex justify-around items-center gap-4 p-2">
                        <img src="{{asset('images/logo1.jpeg')}}" alt="" class="w-12">
                        <h1 class="hidden md:block font-bold text-blue-400 text-xl">ToneZone</h1>
                    </div>
                </a>
            </div>
            <div class="flex items-center justify-around w-4/6 relative">
                <form action="" class="w-4/6 relative flex">
                    <input type="search" name="search" class=" pl-4 py-2 w-full" placeholder="What you looking for ...">
                    <button class="bg-blue-400 text-black font-semibold  px-4 absolute right-1 top-1/2 -translate-y-1/2 py-1 hover:bg-blue-600"><i class="fa-solid fa-magnifying-glass text-md md:mr-2"></i><span class="hidden md:inline">Search</span></button>
                </form>
            </div>
            <div class="flex justify-between items-center h-full header-right">
                <ul class="flex items-center">
                    ...
                    <li>
                        <a href="/logout" class="text-blue-400 flex items-center mr-4 hover:text-white">
